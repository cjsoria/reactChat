  ...
  render: function () {
    return (
      React.createElement("div", {className: "chat-box"}, 
        React.createElement("h1", {className: "title"}, "Chat whit React"), 
  ...
  render: function () {
    return (
      React.createElement("form", {className: "chat-form", onSubmit: this.handleSubmit}, 
        React.createElement("input", {className: "input username-input", type: "text", placeholder: "Type your nick", ref: "username"}), 
        React.createElement("input", {className: "input body-input", type: "text", placeholder: "Type your message", ref: "body"}), 
